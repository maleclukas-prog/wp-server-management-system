...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - CENTRAL CONFIGURATION
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - EMAIL ALERT MODULE
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - DAILY SYSTEM CHECK
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - ENHANCED EXECUTIVE DIAGNOSTICS
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - WORDPRESS FLEET STATUS MONITOR
# =================================================================

source "$HOME/scripts/wsms-config.sh"
GREEN='\033[0;32m'; YELLOW='\033[1;33m'; CYAN='\033[0;36m'; RED='\033[0;31m'; NC='\033[0m'

echo -e "${CYAN}📊 WORDPRESS FLEET STATUS v4.4${NC}"
echo "=========================================================="
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - MULTI-INSTANCE DEEP AUDIT
# =================================================================

source "$HOME/scripts/wsms-config.sh"
CYAN='\033[0;36m'; YELLOW='\033[1;33m'; GREEN='\033[0;32m'; RED='\033[0;31m'; NC='\033[0m'

echo -e "${CYAN}🔍 INITIATING MULTI-SITE DEEP AUDIT v4.4${NC}"
echo "=========================================================="
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - FLEET-WIDE MAINTENANCE ENGINE
# =================================================================
...
echo "=========================================================="
echo "🔄 MAINTENANCE ENGINE v4.4 - $(date)"
echo "=========================================================="
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - INFRASTRUCTURE PERMISSION ORCHESTRATOR
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - FULL RECOVERY BACKUP
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - ESSENTIAL ASSETS BACKUP (LITE)
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - MYSQL BACKUP MANAGER
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - NAS SFTP SYNC (Production)
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - SMART RETENTION MANAGER
# =================================================================
...
list_backups() {
    echo -e "${CYAN}📋 ALL BACKUPS WITH DETAILS v4.4${NC}"
    echo "=========================================================="
...
show_size() {
    echo -e "${CYAN}💽 BACKUP STORAGE USAGE v4.4${NC}"
    echo "=========================================================="
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - INTERACTIVE BACKUP TOOL
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - RED-ROBIN SYSTEM BACKUP
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - WP-CLI INFRASTRUCTURE VALIDATOR
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - LOCAL HOSTS SYNC
# =================================================================
...
#!/bin/bash
# =================================================================
# WSMS PRO v4.4 - SYSTEM CLEANUP SCRIPT
...
echo -e "${CYAN}==========================================================${NC}"
echo -e "${CYAN}   🧹 WSMS PRO v4.4 - SYSTEM CLEANUP                       ${NC}"
echo -e "${CYAN}==========================================================${NC}"
...
# ==================== FINAL SUMMARY ====================
echo -e "\n${GREEN}==========================================================${NC}"
echo -e "${GREEN}✅ WSMS PRO v4.4 INSTALLATION COMPLETE!${NC}"
echo -e "${GREEN}==========================================================${NC}"
echo ""
